<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true>
    ...
    <head>
        ...
        <style>
            ...
            .mdl-textfield__label:after {
               background-color: #67a7de !important;
            }
        ...
        <link rel="mask-icon" href="${url.resourcesPath}/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
    ...
    <body class="${properties.kcBodyClass!}">
        <div class="toolbar">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/logo_platona-m_stencil.png">
        </div>
